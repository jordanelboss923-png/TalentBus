    ...
    public partial class FrmAsignacionesEmpleado : Form
    {
        ...
        private async void CargarDatos()
        {
            try
            {
                ...
                RenombrarColumna("Asignacion", "Asignación");
        ...
        private void BtnNuevo_Click(object sender, EventArgs e)
        {
            ...
            _idSeleccionado = -1;
            LimpiarFormulario();
            lblTituloFormulario.Text = "Nueva Asignación de Empleado";
        ...
        private void Grid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string colName = dgvAsignaciones.Columns[e.ColumnIndex].Name;
            DataRow row = ((DataTable)dgvAsignaciones.DataSource).Rows[e.RowIndex];
            ...
            if (colName == "btnEditar")
            {
                ...
                lblTituloFormulario.Text = "Editar Asignación de Empleado";
            ...
            else if (colName == "btnEliminar")
            {
                ...
                if (MessageBox.Show(
                        $"¿Eliminar esta asignación (ID: {id})?",
        ...
        private void BtnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(
                    $"¿Eliminar esta asignación (ID: {_idSeleccionado})?",
                    "Confirmar eliminación",
                    MessageBoxButtons.YesNo,
                    MessageBoxIcon.Warning) == DialogResult.Yes)
            {
        ...
        private void ActualizarPosicionGrid()
        {
            if (pnlFormulario.Visible)
            {
                ...
                dgvAsignaciones.Location = new Point(dgvAsignaciones.Left, 310);
            }
            else
            {
        ...
        private void RenombrarColumna(string nombre, string encabezado)
        {
            if (dgvAsignaciones.Columns.Contains(nombre))
                dgvAsignaciones.Columns[nombre].HeaderText = encabezado;
        }
